  ...
  return (
    <section className={"bg-black"}>
      <Container className={"-mt-28"}>
        <div className={"bg-dark-gray rounded flex flex-col pb-10 px-20"}>
          <MSectionTitle
            underlined={false}
            primary={"The Basics Of Healthy Food"}
            secondary={"ABOUT"}
          />
          <div className={"flex justify-center"} style={{color: "#A6A6A6"}}>
            <motion.p
              ...
              viewport={{once: true}}
              className={"pb-10 max-w-xl text-center"}>
              In aliqua ea ullamco ad est ex non deserunt nulla. Consectetur
              sint ea aliquip aliquip consectetur voluptate est. Eu minim dolore
